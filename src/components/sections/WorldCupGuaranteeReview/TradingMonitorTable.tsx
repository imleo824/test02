...
export const TradingMonitorTable: React.FC = () => {
  ...
  return (
    <div
      className="rounded-2xl border border-slate-100 bg-white p-6 md:p-8"
    ...
    >
        ...
        <div>
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-bold text-blue-900 bg-blue-50 px-1 md:px-2 lg:px-3 py-1 rounded-full border border-blue-200">
                26年下半年重点协同建设方向
              </span>
            </div>
          </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="rounded-xl border border-slate-100 bg-slate-50 border border-slate-100 p-2 md:p-3 lg:p-4 space-y-2">
            <div className="flex items-center justify-between gap-2 border-b border-slate-100 pb-2">
              ...
              <div className="text-sm font-black text-emerald-900 bg-emerald-50 px-0.5 md:px-1 lg:px-2 py-0.5 rounded-full">
                进度：90%
              </div>
            </div>
            <p className="text-base text-slate-900 font-bold leading-relaxed">
          ...
          <div className="rounded-xl border border-slate-100 bg-slate-50 border border-slate-100 p-2 md:p-3 lg:p-4 space-y-2">
            <div className="flex items-center justify-between gap-2 border-b border-slate-100 pb-2">
              ...
              <div className="text-sm font-black text-blue-900 bg-blue-50 px-0.5 md:px-1 lg:px-2 py-0.5 rounded-full">
                进度：45%
              </div>
            </div>
            <p className="text-base text-slate-900 font-bold leading-relaxed">
