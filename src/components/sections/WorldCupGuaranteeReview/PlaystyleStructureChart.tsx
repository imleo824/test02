          ...
          <div>
            ...
            <div className="grid grid-cols-1 gap-8 mb-8">
              ...
              <div className="space-y-4">
                ...
                <div className="h-[300px] w-full bg-slate-50 border border-slate-100 rounded-xl p-3 border border-slate-100">
              ...
              {killRateBreakdownCards.map((item, index) => {
                ...
                const renderBarRow = (row: any, level = 0) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className="h-full bg-slate-200 rounded-sm overflow-hidden">
                          <div
                ...
                return (
                  ...
                  >
                    ...
                    <div className="bg-slate-50 border border-slate-100 rounded-xl p-5 border border-slate-100 space-y-4 flex-1 flex flex-col justify-center">
