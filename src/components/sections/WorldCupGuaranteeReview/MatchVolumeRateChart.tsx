...
const PlaystyleTooltip = ({ active, payload }: any) => {
  ...
  return (
    <div className="rounded-lg border border-slate-100 bg-white p-1 md:p-2 lg:p-3.5 min-w-[220px] text-slate-900">
      <div className="text-base font-black text-slate-900 mb-2 pb-1.5 border-b border-slate-100">
        {row.name} 玩法
      </div>
      <div className="space-y-1.5 text-base font-bold">
        <div className="flex items-center justify-between gap-4">
          <span className="text-slate-900 font-bold">1. 投注流水</span>
          <span className="font-mono text-slate-900">
            {row.volume.toLocaleString()}
          </span>
        </div>
        <div className="flex items-center justify-between gap-4">
          <span className="text-slate-900 font-bold">2. 盈亏金额</span>
        ...
        <div className="flex items-center justify-between gap-4">
          <span className="text-slate-900 font-bold">3. 盈利率 (杀率)</span>
          <span className="font-mono font-black">
            <span
        ...
        {row.betsCount && (
          <div className="flex items-center justify-between gap-4 border-t border-slate-100 pt-1.5">
            <span className="text-slate-900 font-bold">4. 注单数量</span>
            <span className="font-mono text-slate-900">
        ...
        {row.playersCount && (
          <div className="flex items-center justify-between gap-4">
            <span className="text-slate-900 font-bold">5. 投注人数</span>
            <span className="font-mono text-slate-900">
        ...
        {row.volumeShare && (
          <div className="flex items-center justify-between gap-4">
            <span className="text-slate-900 font-bold">6. 流水占比</span>
            <span className="font-mono text-slate-900">{row.volumeShare}</span>
          </div>
        )}
      </div>
    </div>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-6 mb-6">
        <div className="mb-4 border-b border-slate-100 pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
            ...
            <div className="flex items-center gap-4 text-sm font-black text-slate-900 bg-slate-50 px-1 md:px-2 lg:px-3 py-1 rounded border border-slate-100 flex-wrap">
        ...
        <div className="mt-6">
          <div className="mb-6">
            <h6 className="text-xl font-black text-slate-900 tracking-tight mb-4 flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3 mb-6">
          {matchStageRanges.map((stage) => {
            ...
            return (
              <div
                key={stage.label}
                className="p-1 md:p-2 lg:p-3 rounded-xl border border-slate-100 bg-slate-50 flex flex-col justify-between"
              >
                <div className="flex items-center justify-between gap-1 mb-1.5 border-b border-slate-100 pb-1.5">
                  <span className="text-[13px] font-black text-slate-900 truncate">
                    {stage.label}
                  </span>
                  <span className="text-xs text-slate-900 font-bold bg-slate-100 px-1 py-0.5 rounded ">
                    {stage.count} 场
                  </span>
                </div>
        ...
        {/* 赛事特征分析 */}
        <div className="mt-12 mb-2 border-t border-slate-100 pt-8">
          <h6 className="text-xl font-black text-slate-900 tracking-tight flex items-center gap-2 mb-4">
          ...
          <div className="grid grid-cols-1 gap-8 mt-4">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex-none">
                <div className="grid grid-cols-1 gap-4">
                  {/* 各阶段绝杀绝平场次比例 */}
                  <div className="bg-white rounded-xl border border-slate-100 p-5 h-[480px] flex flex-col ">
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex-none">
                <div className="bg-white rounded-xl border border-slate-100 p-5 h-[480px] flex flex-col  overflow-hidden">
                    ...
                    <table className="w-full font-bold border-collapse text-slate-900 table-fixed w-full report-dense-table">
                      ...
                      <tbody className="bg-white divide-y divide-slate-100">
                        {lossDetailsData.slice(0, 10).map((item) => {
                          return (
                            <tr key={item.rank} className="hover:bg-slate-50 transition-colors bg-white">
                              ...
                              <td className="px-2 md:px-3 lg:px-4 py-3 text-center">
                                <span
                                  className={`inline-flex items-center rounded-md px-1.5 py-0.5 text-xs font-bold border ${
        ...
        <div className="mt-12 border-t border-slate-100 pt-8">
          <div className="mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 border-b border-slate-100 pb-3">
              <h6 className="text-xl font-black text-slate-900 tracking-tight flex items-center gap-2">
                <span className="w-1.5 h-5 bg-emerald-600 rounded-full" />
                核心玩法盈利分析
              </h6>
              <div className="flex items-center gap-3 text-sm font-black text-slate-900 bg-slate-50 px-1 md:px-2 lg:px-3 py-1 rounded border border-slate-100 flex-wrap">
                <span className="flex items-center gap-1.5">
                  <span className="w-3 h-3 bg-[#059669] rounded-xs" />
                  盈利金额
                </span>
      ...
      <div className="rounded-2xl border border-slate-100 bg-white p-6 mb-6">
        <div className="mb-4 border-b border-slate-100 pb-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-2">
            ...
            <div className="flex items-center gap-3 text-sm font-bold text-slate-900 bg-slate-50 px-1 md:px-2 lg:px-3 py-1 rounded border border-slate-100">
              <span className="flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 gap-4 mt-4 mb-8">
          <div className="p-2 md:p-3 lg:p-4 bg-slate-50 rounded-2xl border border-slate-100">
          ...
          <div className="p-2 md:p-3 lg:p-4 bg-slate-50 rounded-2xl border border-slate-100">
            ...
            <div className="text-3xl font-mono text-slate-900 font-black tracking-tighter flex items-baseline gap-1">
              <SignColoredValue
        ...
        {/* 预期水钱标准 */}
        <div className="mt-6 mb-6 p-2 md:p-3 lg:p-4 bg-slate-50 rounded-xl border border-slate-100">
          <p className="text-sm text-slate-900 font-bold leading-relaxed mb-1.5 flex items-start gap-2">
          ...
          <p className="text-sm text-slate-900 font-bold leading-relaxed flex items-start gap-2">
            <span className="w-1.5 h-1.5 bg-slate-400 rounded-full mt-2 shrink-0" />
            <span>
              {highlightNumbers(
        ...
        <div className="mt-8">
          <div className="mb-6">
            <h6 className="text-lg font-black text-slate-900 tracking-tight mb-3 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
              {[
                ...
                return (
                  <div
                    key={stage.label}
                    className="p-1 md:p-2 lg:p-3.5 rounded-xl border border-slate-100 bg-slate-50 border border-slate-100 flex flex-col justify-between "
                  >
                    <div className="flex items-center justify-between gap-1 mb-2 border-b border-slate-100 pb-1.5">
                      <span className="text-[13px] font-black text-slate-900 truncate">
                        {stage.label}
                      </span>
                      <span className="text-xs text-slate-900 font-bold bg-slate-200 px-1.5 py-0.5 rounded-md ">
                        {stage.count} 场
                      </span>
                    </div>
                    <div className="space-y-1.5 text-sm">
                      <div className="flex items-center justify-between">
                        <span className="text-slate-900 font-bold">预期水钱</span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-slate-900 font-bold">实际水钱</span>
                        <span className="font-mono font-bold text-slate-900">
                      ...
                      <div className="flex items-center justify-between border-t border-slate-100 pt-1.5">
                        <span className="text-slate-900 font-bold">水钱差</span>
                        <span
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-slate-900 font-bold">抽水率差</span>
                        <span
                          className={`font-mono font-black ${
                            isLoss ? "text-rose-600" : "text-emerald-600"
                          }`}
            ...
            <SummaryBox>
              ...
              <ul className="mt-4 list-disc list-outside ml-5 space-y-2 text-slate-900 font-bold">
                <li className="flex items-start gap-2 text-sm text-slate-900 font-bold">
                  ...
                  <span>
                    {highlightNumbers(
                      "[[玩法状态]]：在 [[blue:4个核心玩法]] 中，有 [[red:3个呈亏水]] 状态（其中 [[全场大小]] 亏水 [[red:-2,141.05]]，[[全场让球]] 亏水 [[red:-158.53]]，[[上半场让球]] 亏水 [[red:-94.87]]；仅 [[上半场大小]] 呈 [[green:+483.04]] 正向偏离）。",
                    )}
                  </span>
                </li>
                <li className="flex items-start gap-2 text-sm text-slate-900 font-bold">
                  ...
                  <span>
                    {highlightNumbers(
                      "[[阶段特征]]：结构上[[早盘均未亏水]]，亏水全部集中于[[滚球阶段]]。风控对[[早盘监控更为提前]]，拥有充足时间与B端沟通调整；而[[滚球阶段]]受实时动态因素较多限制，风控可干预时空有限，后续主要依赖操盘端策略与工具的升级优化。",
                    )}
                  </span>
                </li>
              </ul>
              ...
              <tbody className="bg-white divide-y divide-slate-100">
                {playstyleWaterDiffData.map((item, index) => (
                  <tr 
                    ...
                    className={`${item.isSub ? "bg-slate-50" : "bg-white font-bold"}`}
                  >
                    <td className={`py-2.5 px-4 border-r border-slate-100 text-xs ${item.isSub ? "pl-10 text-slate-900 font-bold italic" : "text-slate-900 font-black"}`}>
                      {!item.isSub ? "● " : "└ "}
                      {item.name}
                    </td>
                    <td className="px-2 md:px-3 lg:px-4 py-3 text-right">
                ...
                {/* Total row */}
                <tr className="bg-slate-50 text-slate-900 font-black border-t-2 border-slate-100">
                  <td className="px-2 md:px-3 lg:px-4 py-3 text-center">
                    总计
                  </td>
                  <td className="px-2 md:px-3 lg:px-4 py-3 text-right">
