    ...
    <div className="mb-6 rounded-2xl border border-slate-100 bg-white p-5">
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="relative rounded-xl border border-slate-100 bg-slate-50 border border-slate-100 p-4">
            <div className="flex items-start gap-3">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-white border border-slate-100 text-slate-900">
