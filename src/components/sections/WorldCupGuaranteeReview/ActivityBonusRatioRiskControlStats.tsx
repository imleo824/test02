...
export const ActivityBonusRatioRiskControlStats = () => {
  ...
  return (
    <div className="bg-white border border-slate-100 rounded-xl p-2 md:p-3 lg:p-4 md:p-5 overflow-hidden space-y-4">
      <div className="flex flex-col gap-3 border-b border-slate-100 pb-3">
        <div className="flex items-center justify-between gap-4">
          <h5 className="text-sm md:text-base font-black tracking-tight text-slate-900 flex items-center gap-2.5">
            <span>2. 全部活动风控率</span>
          </h5>
        </div>
        <SummaryBox className="mt-2 mb-0 p-2 md:p-3 lg:p-4">
          {highlightNumbers(
        ...
        <table className="w-full font-bold border-collapse text-slate-900 table-fixed w-full report-dense-table">
          <thead className="bg-slate-100 text-slate-900 ">
            <tr className="bg-slate-100 border-b border-slate-100 text-slate-900 font-black text-sm uppercase tracking-wider">
              <th
                rowSpan={2}
                className="py-1 md:py-2 lg:py-3 px-4 text-left border-r border-slate-100 text-slate-900 font-black "
              >
                红利/存款
              </th>
              <th
                rowSpan={2}
                className="py-1 md:py-2 lg:py-3 px-4 text-right border-r border-slate-100 text-slate-900 font-black"
              >
                总人数
              </th>
              <th
              ...
              <th
                colSpan={5}
                className="py-0.5 md:py-1 lg:py-2.5 px-4 text-center border-b border-slate-100 text-slate-900 font-black bg-slate-100"
              >
                会员输赢
              </th>
              <th
              ...
              <th
                rowSpan={2}
                className="py-1 md:py-2 lg:py-3 px-4 text-right w-48 text-slate-900 font-black border-l border-slate-100"
              >
                风控率
              </th>
            </tr>
            <tr className="bg-slate-50 border-b border-slate-100 text-slate-900 font-black text-sm">
          ...
          <tbody className="bg-white divide-y divide-slate-100">
              ...
              <tr key={item.range} className=" ">
                ...
                <td className="px-2 md:px-3 lg:px-4 py-3 text-center">
                  <div className="flex items-center justify-end gap-3">
                    ...
                    <div className="flex-1 bg-slate-200 rounded-full h-1.5 overflow-hidden max-w-[100px] hidden sm:block border border-slate-100">
                      <div
            ...
            <tr className="bg-blue-50 font-black text-slate-900 border-t border-slate-100">
              <td className="px-2 md:px-3 lg:px-4 py-3 text-center">
                汇总
              </td>
              <td className="px-2 md:px-3 lg:px-4 py-3 text-right">
