...
export const AgentRiskControlSection: React.FC = () => {
  ...
  return (
    <div id="section-agent-risk-control" className="space-y-10">
      {/* 3.5 代理风控 模块主标题 */}
      <div className="bg-slate-900 text-white rounded-xl py-1 md:py-2 lg:py-3 px-5 ">
      ...
      <div className="grid grid-cols-1 gap-6 items-stretch">
        ...
        <div
          ...
          className="bg-slate-50 border border-slate-100 rounded-xl p-5 space-y-4 flex flex-col justify-between"
        >
          <div className="space-y-4 flex-1 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {/* 原来模式 */}
                <div className="bg-white border border-slate-200 rounded-lg p-1 md:p-2 lg:p-3 space-y-1.5">
                  ...
                  <p className="text-xs font-bold text-slate-900">组长与代理长期绑定，手工核算、缺乏机制隔离，极易产生内外勾结泄露。</p>
                  <div className="bg-slate-50 border border-slate-100 p-0.5 md:p-1 lg:p-2 rounded text-slate-900 font-mono font-black text-xs text-center">
                    固定关联：组长 A → 代理 A
                  </div>
                </div>
                ...
                <div className="bg-white border border-slate-200 rounded-lg p-1 md:p-2 lg:p-3 space-y-1.5">
                  ...
                  <p className="text-xs font-bold text-slate-900">系统多维度交叉评估、随机分配，并逐月进行差异化轮换派单。</p>
                  <div className="grid grid-cols-2 gap-2 text-xs font-mono font-bold items-center text-center">
                    <div className="bg-slate-50 border border-slate-100 p-0.5 md:p-1 lg:p-2 rounded text-slate-900">
                      <div className="text-[9px] text-slate-900 font-sans font-bold mb-0.5">上月</div>
                      组长 A → 代理 A
                    </div>
                    <div className="bg-emerald-50 border border-emerald-200 p-0.5 md:p-1 lg:p-2 rounded text-emerald-900">
                      <div className="text-[9px] text-emerald-950 font-sans font-bold mb-0.5 flex items-center justify-center gap-1">
                        <span>🔀 随机轮换</span>
                      </div>
                      组长 B → 代理 A
                    </div>
        ...
        >
          <div className="space-y-4 flex-1 flex flex-col justify-between">
            <div className="space-y-4">
              ...
              <div className="bg-white border border-slate-200 rounded-lg p-1 md:p-2 lg:p-3 space-y-2">
                ...
                <div className="bg-rose-50 border border-rose-200 text-rose-950 font-black text-xs py-1.5 text-center rounded">
                  🚨 触发异常预警（偏差值超过5%设定阈值）
                </div>
              </div>
            </div>
